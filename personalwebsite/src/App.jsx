  ...
  return (
    <>
      ...
      <div className="bg-black w-full min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-3 gap-15 h-[24vw]">
          <div className="bg-white w-[24vw] rounded-3xl items-center justify-center flex skillshadow">

          </div>
          <div className="bg-black w-[24vw] rounded-3xl items-center justify-center flex skillshadow">
